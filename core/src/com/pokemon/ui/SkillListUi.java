...
public class SkillListUi extends AbstractUi{
    ...
    public void update() {
        ...
        for(int i=0;i<player.skill.length;i++) {
            ...
            skillEXP_C[i].setPosition(headers.getX() + 120+(4-skillEXP_C.length)*2,headers.getY()-45-i*50);
            skillEXP_M[i].setPosition(headers.getX() + 135+(skillEXP_C.length-1)*2, headers.getY()-45-i*50);
