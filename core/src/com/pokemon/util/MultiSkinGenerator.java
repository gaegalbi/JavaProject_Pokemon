 ...
 * @author hydrozoa
 */
public class MultiSkinGenerator {
    ...
    public static Skin generateSkin(AssetManager assetManager) {
        ...
        buttonSquareBlue.setMiddleHeight(80);
